...
public class user_listActivity extends AppCompatActivity {
    ...
    private void showData() {
        ...
        adapter = new Adapter_userlist(user_listActivity.this, modelList_showlist);
    ...
    public void nextActivity(int position) {
        ...
        Intent intent = new Intent(user_listActivity.this, user_dataActivity.class);
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        if(item.getItemId()==R.id.action_history){
            startActivity(new Intent(user_listActivity.this, history_list.class));
        }
