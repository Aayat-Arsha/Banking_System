...
public class user_dataActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressDialog = new ProgressDialog(user_dataActivity.this);
    ...
    private void enterAmount() {
        final AlertDialog.Builder mBuilder = new AlertDialog.Builder(user_dataActivity.this);
        ...
        dialog.getButton(AlertDialog.BUTTON_POSITIVE).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(mAmount.getText().toString().isEmpty()){
                    ...
                    Intent intent = new Intent(user_dataActivity.this, sendtouserActivity.class);
    ...
    private void transactionCancel() {
        AlertDialog.Builder builder_exitbutton = new AlertDialog.Builder(user_dataActivity.this);
        builder_exitbutton.setTitle("Do you want to cancel the transaction?").setCancelable(false)
                .setPositiveButton("yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        ...
                        new DatabaseHelper(user_dataActivity.this).insertTransferData(date, name.getText().toString(), "Not selected", "0", "Failed");
                        Toast.makeText(user_dataActivity.this, "Transaction Cancelled!", Toast.LENGTH_LONG).show();
                    }
